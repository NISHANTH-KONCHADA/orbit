    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-col justify-center w-1/2 bg-gradient-to-br from-orbit-500 via-orbit-600 to-orange-700 p-12 text-white relative overflow-hidden">
        ...
        <div className="relative z-10">
          {/* Back to home */}
          <Link to="/" className="inline-flex items-center gap-1.5 text-white/70 hover:text-white text-sm mb-12 transition-colors">
          ...
          <h1 className="text-4xl font-bold leading-tight mb-4">Join the mission.</h1>
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white dark:bg-gray-950">
        <div className="w-full max-w-sm animate-slide-up">
          ...
          <div className="flex items-center justify-between mb-8 lg:hidden">
            ...
            <Link to="/" className="inline-flex items-center gap-1 text-xs text-gray-400 hover:text-gray-600 dark:hover:text-gray-300 transition-colors">
